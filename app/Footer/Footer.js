...
import testimonials from "../information";
import styles from "./Footer.module.css";

export default function Footer() {
  return (
    <footer>
      <div className={styles.testimonial_header}>Testimonials</div>
      ...
      <div className={styles.footer_header}>
        ...
        <div className={styles.footer_testimonial_parent}>
          <CustomCarousel>
            <LoadTestimonials />
          </CustomCarousel>
        </div>
  ...
  return (
    <>
      {testimonials.map((testimonial, idx) => {
        return (
          <div key={idx}>
            <div className={styles.footer_testimonial}>
              <div className={`${styles.footer_testimonial_upper}`}>
                <span className={styles.footer_testimonial_name}>
                  {testimonial.name}
                </span>
                <span>|</span>
                <span className={styles.footer_testimonial_position}>
                  {testimonial.position}
                </span>
              </div>
              <div className={styles.footer_testimonial_comment}>
                {testimonial.comment}
              </div>
            </div>
          </div>
